...
function display {
    ...
    # Start
    tellraw @s {"text":"\n\n\n\n"}
    tellraw @s {"text":"    Advanced AFK Config","bold":true,"color":"gold"}
    ...
    execute if data storage adaf:data gamerules{time:1} run {
          tellraw @s [{"text":"Auto afk time: ","color":"gold","hoverEvent":{"action":"show_text","contents":"Time after the player is marked as afk."}},{"text":"[ - ] ","color":"gray","hoverEvent":{"action":"show_text","contents":""}},{"score":{"name":".temp0","objective":"adaf.data"},"color":"red","hoverEvent":{"action":"show_text","contents":""}},{"text":" [ + ]","color":"dark_green","hoverEvent":{"action":"show_text","contents":""},"clickEvent": {"action": "run_command", "value": "/function adaf:menu/buttons/time/add"}}]
    }
    execute unless data storage adaf:data gamerules{time:1} run {
        tellraw @s [{"text":"Auto afk time: ","color":"gold","hoverEvent":{"action":"show_text","contents":"Time after the player is marked as afk."}},{"text":"[ - ] ","color":"dark_red","hoverEvent":{"action":"show_text","contents":""},"clickEvent": {"action": "run_command", "value": "/function adaf:menu/buttons/time/remove"}},{"score":{"name":".temp0","objective":"adaf.data"},"color":"red","hoverEvent":{"action":"show_text","contents":""}},{"text":" [ + ]","color":"dark_green","hoverEvent":{"action":"show_text","contents":""},"clickEvent": {"action": "run_command", "value": "/function adaf:menu/buttons/time/add"}}]
    }
...
dir buttons {
    dir time {
        function add {
            execute store result score .temp0 adaf.data run data get storage adaf:data gamerules.time
            scoreboard players add .temp0 adaf.data 1
            execute store result storage adaf:data gamerules.time int 1 run scoreboard players get .temp0 adaf.data

            function adaf:menu/display
        }
        function remove {
            execute store result score .temp0 adaf.data run data get storage adaf:data gamerules.time
            scoreboard players remove .temp0 adaf.data 1
            execute store result storage adaf:data gamerules.time int 1 run scoreboard players get .temp0 adaf.data
