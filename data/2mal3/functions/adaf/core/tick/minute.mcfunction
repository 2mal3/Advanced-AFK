...
# A player is afk
execute if score $adaf.auto_afk adaf.config matches 1 as @a[tag=!adaf.afk,tag=!global.ignore] if score $adaf.time adaf.config = @s adaf.afk_time run function 2mal3:adaf/add_afk/main
...
schedule function 2mal3:adaf/core/tick/minute 60s
